...
3. **Просмотр API контракта (Swagger):**
...
- **ApplicationRole** - Роли пользователей внутри приложений.

## Задания в рамках проекта

| **Задание** | **Дедлайн** | **Статус** |
| --- | --- | --- |
| Инициализация проекта, ERD, контракт для REST API | 27/11/25 | ***В работе*** |
| Реализация работы с БД | 07/12/25 | ***Запланировано*** |
